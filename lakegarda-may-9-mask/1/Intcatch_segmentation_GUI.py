...
class SegmentationGUI(Frame):
    ...
    def main_window(self):
        ...
        self.panelA = Canvas(root, width=800, height=400, background="bisque")
        ...
        RadioButtonChoiceTheMask1=Radiobutton(root, text="Water", padx = 10, variable=self.mask_type_choice, value=1)
        RadioButtonChoiceTheMask2=Radiobutton(root, text="Other", padx = 10, variable=self.mask_type_choice, value=2)
        RadioButtonChoiceTheMask3=Radiobutton(root, text="Undo", padx = 10, variable=self.mask_type_choice, value=3)
        RadioButtonChoiceTheMask4 = Radiobutton(root, text="Vegetation", padx=10, variable=self.mask_type_choice, value=4)
        RadioButtonChoiceTheMask5 = Radiobutton(root, text="Boats", padx=10, variable=self.mask_type_choice,  value=5)
        RadioButtonChoiceTheMask6 = Radiobutton(root, text="Sky", padx=10, variable=self.mask_type_choice, value=6)
        ...
        RadioButtonChoiceTheMask4.grid(row=1,column=7)
        RadioButtonChoiceTheMask5.grid(row=2,column=7)
        RadioButtonChoiceTheMask6.grid(row=3,column=7)
    ...
    def adjust_mask(self):
        if(self.path!=None):
            ...
            self.panelB = Canvas(self.t, width=1000, height=500, background="bisque")
            ...
            RadioButtonChoiceTheMask4.grid(row=2,column=0)
            RadioButtonChoiceTheMask5.grid(row=2,column=1)
            RadioButtonChoiceTheMask6.grid(row=2,column=2)

            RadioButtonPenSize1.grid(row=3,column=0)
            RadioButtonPenSize2.grid(row=3,column=1)
            RadioButtonPenSize3.grid(row=3,column=2)
            btnCloseAdjustMask.grid(row=4,column=1)
    ...
    def select_segment(self,event):
        if(self.path!=None):
            ...
            image2[:,:,:]=np.where(self.mask, (100,100,255), image2[:,:,:])
            image2[:,:,:]=np.where(self.mask, (255,255,255), image2[:,:,:])
            image2[:,:,:]=np.where(self.mask, (0,0,0), image2[:,:,:])
            image2[:,:,:]=np.where(self.mask, (0,255,0), image2[:,:,:])
            image2[:,:,:]=np.where(self.mask, (200,8,21), image2[:,:,:])
            image2[:,:,:]=np.where(self.mask, (153,17,153), image2[:,:,:])
